...
async function snapshotTemplate() {
  ...
  html = html
    ...
    .replace(
      "{{TABLE_ROWS}}",
      '<tr><td style="text-align:center">1</td><td>Software services</td><td style="text-align:right">7840</td><td style="text-align:right">7840</td><td style="text-align:center">$</td></tr>'
    )
