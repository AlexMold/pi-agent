...
class RoutingEngine {
  constructor(options = {}) {
    ...
    this.piPath = options.piPath || process.env.PI_PATH || path.join(process.env.HOME || "", ".nvm/versions/node/v24.13.0/bin/pi");
  ...
  async routeByLLM(query) {
    ...
    const systemPrompt = `You are a semantic router for the ${this.botName}. Your task is to categorize the user's query into one of the following routes.
